...
final class ElectricImportExportSeriesQueryTest extends TestCase
{
    ...
    public function testReturnsSeriesWithAccumulationAndOrdering(): void
    {
        ...
        // Costs: export 2kWh * 10p = -20p; import 1kWh * -20p = 20p
        $this->assertEqualsWithDelta(-20.0, $first['export_cost'], 0.001);
        $this->assertEqualsWithDelta(20.0, $first['import_cost'], 0.001);
        $this->assertEqualsWithDelta(20.0, $first['export_accumulative_cost'], 0.001);
        $this->assertEqualsWithDelta(-20.0, $first['import_accumulative_cost'], 0.001);
        ...
        // Costs: export £0.20 + (1kWh*20p=£0.20)=40p; import £0.20 + (3kWh*-40p = -140p) = -100p
        $this->assertEqualsWithDelta(40.0, $second['export_accumulative_cost'], 0.001);
        $this->assertEqualsWithDelta(-140.0, $second['import_accumulative_cost'], 0.001);
        $this->assertEqualsWithDelta(-100.0, $second['net_accumulative_cost'], 0.001);
