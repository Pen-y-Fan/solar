...
final readonly class GenerateStrategyCommandHandler implements CommandHandler
{
    public function __construct(private GenerateStrategyAction $action)
    {
    }
        ...
        try {
            ...
            if (!$result->isSuccess()) {
                Log::warning('GenerateStrategyCommand failed', [
                    ...
                    'message' => $result->getMessage() ?? 'Strategy generation failed',
