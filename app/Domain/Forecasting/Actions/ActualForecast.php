...
use App\Domain\Forecasting\Models\ActualForecast as ActualForecastModel;
...
class ActualForecast
{
    public function run()
    {
        ...
        $lastForecast = ActualForecastModel::latest('updated_at')->first();
